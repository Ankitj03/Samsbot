...
class Address extends Component {
    ...
    componentDidMount() {
        axios.get('http://18.206.140.135:3001/addressUpdate')
            .then((response) => {
    ...
    updateAddress = (e) => {
        ...
        axios.post('http://18.206.140.135:3001/userUpdateAddress', data)
            .then(response => {
    ...
    addAddress = (e) => {
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.post('http://18.206.140.135:3001/userAddAddress', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    this.setState({
