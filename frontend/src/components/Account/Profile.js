...
class Profile extends Component {
    ...
    componentDidMount() {
        axios.get('http://18.206.140.135:3001/userUpdate')
            .then((response) => {
        ...
        axios.get('http://18.206.140.135:3001/userProfileImage')
            .then((response) => {
                console.log((response.data))
                this.setState({
    ...
    uploadImage = () => {
        const uploaders = this.state.pictures.map(picture => {
            ...
            return axios.post('http://18.206.140.135:3001/upload', data)
                .then(response => {
                    ...
                    axios.post('http://18.206.140.135:3001/userUpdateProfileImage', data)
                        .then(response => {
    ...
    submitUpdateName = (e) => {
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.post('http://18.206.140.135:3001/userUpdateName', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    this.setState({
    ...
    submitUpdateEmail = (e) => {
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.post('http://18.206.140.135:3001/userUpdateEmail', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    this.setState({
    ...
    submitUpdatePassword = (e) => {
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.post('http://18.206.140.135:3001/userUpdatePassword', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    this.setState({
