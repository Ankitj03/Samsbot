...
class RestaurantMenu extends Component {
    ...
    componentDidMount() {
        ...
        axios.post('http://18.206.140.135:3001/menuItems', data)
            .then(response => {
        ...
        axios.post('http://18.206.140.135:3001/menuSections', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    console.log(response.data);
    ...
    addItemToCart = (e) => {
        ...
        axios.defaults.withCredentials = true;
        // make a post request with the user data
        axios.post('http://18.206.140.135:3001/addItemToCart', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    this.setState({
