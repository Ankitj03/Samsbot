...
class OwnerProfile extends Component {
    ...
    componentDidMount() {
        axios.get('http://18.206.140.135:3001/ownerUpdate')
            .then((response) => {
        ...
        const uploaders = this.state.pictures.map(picture => {
            ...
            return axios.post('http://18.206.140.135:3001/upload', data)
                .then(response => {
                    ...
                    axios.post('http://18.206.140.135:3001/ownerUpdateProfileImage', data)
                        .then(response => {
        ...
        const uploaders = this.state.pictures.map(picture => {
            ...
            return axios.post('http://18.206.140.135:3001/upload', data)
                .then(response => {
                    ...
                    axios.defaults.withCredentials = true;
                    //make a post request with the user data
                    axios.post('http://18.206.140.135:3001/ownerUpdateRestImage', data)
                        .then(response => {
                            console.log("Status Code : ", response.status);
                            if (response.status === 200) {
                                this.setState({
    ...
    submitUpdate = (e) => {
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.post('http://18.206.140.135:3001/ownerUpdateProfile', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    this.setState({
