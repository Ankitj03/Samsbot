...
class Sections extends Component {
    ...
    componentDidMount() {
        axios.get('http://18.206.140.135:3001/ownerSections')
            .then((response) => {
    ...
    submitSection = (e) => {
        ...
        axios.post('http://18.206.140.135:3001/ownerAddSection', data)
            .then(response => {
    ...
    updateSection = (e) => {
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.post('http://18.206.140.135:3001/ownerUpdateSection', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    this.setState({
    ...
    submitDeleteSection = (e) => {
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.post('http://18.206.140.135:3001/ownerDeleteSection', data)
            .then(response => {
                console.log("Status Code : ", response.status);
                if (response.status === 200) {
                    this.setState({
